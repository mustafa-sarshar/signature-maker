...
import "./assets/scripts/tota11y.min";
import "./assets/scripts/excanvas";
...
lineJoinEl.forEach((item) => {
  item.addEventListener("click", function (evt) {
    if (item.innerText === "ROUND") objOptions["curLineJoin"] = "round";
    else if (item.innerText === "BEVEL") objOptions["curLineJoin"] = "bevel";
    else if (item.innerText === "MITER") objOptions["curLineJoin"] = "miter";
...
const btnDrawSizeSetEl = document.querySelector(
  ".settings__draw-size__btn-set"
);
